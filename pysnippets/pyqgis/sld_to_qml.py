...
sld = """<?xml version="1.0" encoding="UTF-8"?>
        ...
        </StyledLayerDescriptor>"""  # noqa: E501
sld_path = Path(tempfile.gettempdir()) / "sld_style.sld"
with open(sld_path, mode="w") as sld_file:
    sld_file.write(sld)

layer.loadSldStyle(str(sld_path))
qml_path = Path(tempfile.gettempdir()) / "qml_style.qml"
